...
func main() {
	...
	go setupControllers(mgr, cCache, queues, certsReady, &cfg, serverVersionFetcher, cancel)
...
func setupControllers(mgr ctrl.Manager, cCache *cache.Cache, queues *queue.Manager, certsReady chan struct{}, cfg *configapi.Configuration, serverVersionFetcher *kubeversion.ServerVersionFetcher, cancel context.CancelFunc) {
